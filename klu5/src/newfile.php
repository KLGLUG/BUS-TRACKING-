<?php
   ...
   switch($key)
   {
      ...
      case "create":
         ...
         try {
            $sql 	= "INSERT INTO routes (LATITUDE, LONGITUDE) VALUES(:LATITUDE, :LONGITUDE)";
            $stmt 	= $pdo->prepare($sql);
            $stmt->bindParam(':LATITUDE', $latitude);
            $stmt->bindParam(':LONGITUDE', $longitude);
            $stmt->execute();

            echo json_encode(array('message' => 'Congratulations the record ' . $latitude. ' was added to the database'));
         }
